...
export default defineMessages({
  ...
  lede: {
    defaultMessage:
      'After entering your new password and confirming it, hit the button and you will be able to log in after that.',
  ...
  ctaLoading: {
    ...
    id: 'reset-password.cta-loading'
  },
  placeholderNewPassword: {
    defaultMessage: 'New password',
    id: 'reset-password.labels.new-password'
  },
  placeholderConfirmNewPassword: {
    defaultMessage: 'Confirm new password',
    id: 'reset-password.labels.confirm-new-password'
  }
})
